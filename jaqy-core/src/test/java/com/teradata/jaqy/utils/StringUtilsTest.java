...
public class StringUtilsTest
{
    ...
    public void getIntValueTest () throws IOException
    {
        ...
        { (byte) 1, (byte) 2, (byte) 3, (byte) 4 }, StringUtils.getBytesFromHexString ("01020304"));
        Assert.assertArrayEquals (new byte[]
        { (byte) 0x1e, (byte) 0xef, (byte) 0x3c, (byte) 0x41 }, StringUtils.getBytesFromHexString ("1eef3c41"));
        Assert.assertArrayEquals (new byte[]
        { (byte) 0x1e, (byte) 0xef, (byte) 0x3c, (byte) 0x41 }, StringUtils.getBytesFromHexString ("1EEF3C41"));
    }
